...
/*
Writing this to prioritize a new request when it comes in 
*/
...
//state를 기준으로 form이라는 key값에 value를 할당한다. 
const auth = handleActions(
    {
        [CHANGE_FIELD] : (state, {payload : {form, key, value}}) => produce(state, draft => { draft[form][key] = value}),
        [INITIALIZE_FORM] : (state, {payload : form}) => ({...state, [form] : initialState[form], authError : null}), 
